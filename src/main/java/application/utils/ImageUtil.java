...
public class ImageUtil {
    ...
    public WritableImage imgOpacity(Image image, double opacity) {
        ...
        if (opacity < 0 || opacity > 1) {
            throw new MarsException("透明度需要介于0-1之间,请重新设置透明度!");
        }
...
//		 }
    ...
    public WritableImage setBackgroundImg(double opacity) {
        ...
        Image image = new Image(getClass().getResourceAsStream("/img/background/1.png"), screenWidth * 0.6, 0.6 * screenHeight, true, true);
